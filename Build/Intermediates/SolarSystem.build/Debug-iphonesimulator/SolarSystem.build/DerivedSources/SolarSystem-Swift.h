...
SWIFT_CLASS("_TtC11SolarSystem11AppDelegate")
...
SWIFT_CLASS("_TtC11SolarSystem15MyTableViewCell")
@interface MyTableViewCell : UITableViewCell
@property (nonatomic) IBOutlet UIImageView * __null_unspecified cellImage;
@property (nonatomic) IBOutlet UILabel * __null_unspecified cellItemName;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC11SolarSystem21MyTableViewController")
@interface MyTableViewController : UITableViewController
@property (nonatomic, copy) NSArray * __nonnull SystemObject;
@property (nonatomic, copy) NSArray * __nonnull SystemImages;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC11SolarSystem23MyTableViewController_3")
@interface MyTableViewController_3 : UITableViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (NSInteger)numberOfSectionsInTableView:(UITableView * __nonnull)tableView;
- (NSInteger)tableView:(UITableView * __nonnull)tableView numberOfRowsInSection:(NSInteger)section;
...
SWIFT_CLASS("_TtC11SolarSystem30MyTableViewController_Settings")
@interface MyTableViewController_Settings : UITableViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (NSInteger)numberOfSectionsInTableView:(UITableView * __nonnull)tableView;
- (NSInteger)tableView:(UITableView * __nonnull)tableView numberOfRowsInSection:(NSInteger)section;
...
SWIFT_CLASS("_TtC11SolarSystem24MyViewController_Gravity")
@interface MyViewController_Gravity : UIViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
